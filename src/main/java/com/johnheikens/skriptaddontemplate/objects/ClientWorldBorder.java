package com.johnheikens.skriptaddontemplate.objects;
...
import com.johnheikens.skriptaddontemplate.wrappers.OldWrapperPlayServerWorldBorder;
import com.johnheikens.skriptaddontemplate.wrappers.WrapperPlayServerInitializeWorldBorder;
import com.johnheikens.skriptaddontemplate.wrappers.WrapperPlayServerWorldBorderCenter;
import com.johnheikens.skriptaddontemplate.wrappers.WrapperPlayServerWorldBorderSize;
import com.johnheikens.skriptaddontemplate.wrappers.WrapperPlayServerWorldBorderWarningBlocks;
...
public class ClientWorldBorder {
	...
	public void sendRedScreen(long time, TimeUnit timeUnit, Player... players) {
		...
		if (timeUnit == null || time <= 0)
			return;
		Bukkit.getScheduler().runTaskLater(SkriptAddonTemplate.getInstance(), () -> {
