package com.johnheikens.skriptaddontemplate.elements.sections;
...
import com.johnheikens.skriptaddontemplate.events.AnvilGUIEvent;
import com.johnheikens.skriptaddontemplate.events.AnvilGUIEvent.Click;
...
public class SecOpenAnvil extends Section {
	...
	protected @Nullable TriggerItem walk(Event event) {
		...
		AnvilGUI.Builder builder = new AnvilGUI.Builder().title(title.getSingle(event)).plugin(SkriptAddonTemplate.getInstance());
		if (items.size() >= 1)
